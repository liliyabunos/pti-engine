...
Endpoints:
    ...
    GET    /api/v1/tiktok-watchlist                — list TikTok creator watchlist
    POST   /api/v1/tiktok-watchlist                — add TikTok creator to watchlist
    ...
    GET    /api/v1/admin/creator-claims             — admin: list claims (requires X-Pti-Admin-User)
    POST   /api/v1/admin/creator-claims/{id}/approve — admin: approve claim
    POST   /api/v1/admin/creator-claims/{id}/reject  — admin: reject claim (reason required)
...
from perfume_trend_sdk.api.routes import admin_creator_claims, admin_instagram_review, admin_source_intake, alerts, auth, catalog, creator_claims, creators, dashboard, emerging, entities, notes, public_entities, signals, source_submissions, tiktok_oembed, tiktok_watchlist, watchlists
...
app.include_router(admin_creator_claims.router, prefix="/api/v1/admin/creator-claims", tags=["admin-creator-claims"])
