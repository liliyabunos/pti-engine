/**
 * SIG-ID1 — Admin Signal Candidates base GET proxy (Next.js server route).
 *
 * Handles GET /api/admin/signal-candidates (zero extra path segments).
 * POST calls to /api/admin/signal-candidates/{id}/dismiss are handled by
 * the [[...path]]/route.ts sibling.
 *
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error("[admin/signal-candidates] GET backend error:", err);
